	...
	<head>
		...
		<body>
								...
								<div class="details">
									<div class="title d-flex flex-row justify-content-between">
										<div class="titles">
											...
											<h6><?php echo $job_company; ?></h6>					
										</div>
										<ul class="btns">
											<li><a href="#"><span class="lnr lnr-heart"></span></a></li>
											<li><a href="<?php echo $job_apply; ?>" >Apply</a></li>
										</ul>
									</div>
									<p>
										<?php echo $job_des; ?>
									...
									<p class="address"><span class="lnr lnr-map"></span><?php echo $job_add; ?></p>
									<p class="address"><span class="lnr lnr-database"></span> <?php echo $job_sal; ?></p>
								</div>
							</div>	
			...
			<?php 
             ...
             $get_products = "select * from admin_job";
