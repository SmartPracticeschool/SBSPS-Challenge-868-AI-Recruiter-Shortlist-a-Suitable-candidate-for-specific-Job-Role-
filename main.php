...
?>
			  ...
			  <header id="header" id="home">
			    <div class="container">
			    	<div class="row align-items-center justify-content-between d-flex">
				      <div id="logo">
				        <a href="main.php"><img src="img/logo.png" height="40px" alt="" title="" /></a>
				      </div>
				        ...
				        <ul class="nav-menu">
				          ...
				          <li class="menu-has-children"><a href="">Profile</a>
				            <ul>
								...
								<li><a href="logout.php" name="but_logout"><span class="glyphicon glyphicon-log-out" name="but_logout"> Logout</span></a></li>
				            </ul>
				          </li>				          				          
				        </ul>
					...
					<div class="row">
						...
						<div class="col-lg-3 col-md-6">
							<div class="single-feature">
								<h4>Chat</h4>
								<p>
									Chat with the chatterbot no more need of CV.
								</p>
							</div>
						</div>
						<div class="col-lg-3 col-md-6">
							<div class="single-feature">
								<h4>Security</h4>
								<p>
									We securly store your data our database is provided with highly securued firewall.
								</p>
							</div>
						</div>
						<div class="col-lg-3 col-md-6">
							<div class="single-feature">
								<h4>Notifications</h4>
								<p>
									You will be notified when ever a new job is posted.
								</p>
							</div>
						</div>																		
					</div>
				...
				<div class="container">
					<div class="row align-items-center">
						...
						<div class="active-popular-post-carusel">
							...
							<?php
							$res = mysqli_query($con,"select * from admin_job");
							...
							<div class="single-popular-post d-flex flex-row">
								...
								?>
								<div class="details">
									<a href="#"><h4><?php echo $row["job_company"]; ?></h4></a>
							...
							<div class="single-post d-flex flex-row">
								...
								<div class="details">
									<div class="title d-flex flex-row justify-content-between">
										<div class="titles">
											<a href="single.php?job_id=$job_id"><h4><?php// echo $row["job_title"]; ?></h4></a>
											<h6><?php //echo $row["job_company"]; ?></h6>					
										</div>
										<ul class="btns">
    ...
    data-botId="5f002f14e32bea000858e635"
>
